            ...
            <div key={campo.name} className="flex flex-col">
              ...
              <div className="relative group">
                <input
                  ...
                  className={`${styles.input} ${campo.name === "senha" ? "pr-12" : ""}`}
                  required
                />
                ...
                {campo.name === "senha" && (
                  <button
                    ...
                    className="absolute transition-colors -translate-y-1/2 right-3 top-1/2 text-slate-400"
              ...
              {campo.name === "senha" && (
                <p className="mt-1 text-xs italic text-slate-500">
                  Mínimo 6 caracteres, 1 número e 1 especial.
                </p>
              )}
            </div>
          ))}
